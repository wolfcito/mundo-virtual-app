...
2. Use web3.js and ethers.js. The user should be able to switch between the two libraries and everything should work the same.

Everything else is up to you. We recommend using web3-react, but it's not required.

export function Card() {
  return (
    <div className="flex flex-col justify-center mx-6 my-2 bg-black rounded-2xl w-300 h-90 md:flex-col md:mx-10 my-20 lg:flex-row mx-20 my-24">
      <div className="m-6 bg-black w-250 h-80 md:mx-8 mt-8 mb-4 lg:m-6">
        <img
      ...
      <div className="bg-black w-50 h-30 m-6 md:m-8 lg:ml-4 lg:mt-14 mr-10">
        <h1 className="mb-4 text-xl font-bold w-125 md:text-3xl lg:text-4xl">
          Dribbble Rusia VK Community officially launched!
        </h1>
        <p className="mb-8 text-base font-nunito w-100 md:text-xl lg:text-lg mb-4">

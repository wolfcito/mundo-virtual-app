export function Card() {
  return (
    <div className="flex flex-wrap justify-center mx-12 bg-black w-300 h-90 rounded-2xl my-20 ml-4">
      <div className="bg-black w-250 h-80 mt-4 mr-4 mb-4 ml-4">
        <img
      ...
      <div className=" bg-black w-50 h-30 top-63.8 left-217.5 items-center mt-14">
        <h1 className="text-4xlfont-nunito w-125 text-4xl mb-2">
          Dribbble Rusia VK Community officially launched!
        </h1>
        <p className="text-lg font-nunito w-100 text-lg mb-4">
